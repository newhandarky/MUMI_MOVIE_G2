...
public class Ticket_listService {
	...
	public Ticket_listVO addTicket( Integer ticket_orders_id, Integer seat_id,
			Integer movie_time_id , Integer ticket_price) {
	...
	public Ticket_listVO updateTicket(Integer ticket_list_id, Integer ticket_orders_id, Integer seat_id,
			Integer movie_time_id, Integer ticket_price){
	...
	public void deleteTicket(Integer ticket_list_id) {
		dao.delete(ticket_list_id);
	}

	public Ticket_listVO getOneTicket(Integer ticket_list_id) {
