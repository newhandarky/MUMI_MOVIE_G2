            ...
            <div class="main">
                ...
                <div class="hell">
                    <div class="container">
                        <div class="row">
                            <div class="col-5">
                                <input class="btn-sm btn-primary" type="submit" value="新增影廳" id="sava_data" onclick="location.href='./addHall.jsp'" >
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-2">
                            	<button id="select_hall_btn" type="button" class="btn btn-primary btn-sm" style="float:left">送出</button>
                            </div>
                        </div>
                    </div>
                </div>
