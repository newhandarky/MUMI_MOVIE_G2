...
<head>
    ...
    <!-- css檔連結記得修改 -->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/view/movie/css/movie_overview.css">
...
<body>
        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <div class="d-grid gap-2 d-flex justify-content-end">
                    <button type="button" class="btn btn-outline-primary">更多電影</button>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="container1">
                    <div class="movie_info">
                        <a href="">
                            <img src="IMAGE/moviestand/1825.jpg" alt="" class="img_poster">
                        </a>
                        <div class="title_info">
                            <h5 class="title_name">咒術迴戰0</h5>
                            <img src="IMAGE/icons/mrs_12.png" alt="" class="level">
                        </div>
                    ...
                    <div class="movie_info">
                        <a href="">
                            <img src="IMAGE/moviestand/film_20220214007.jpg" alt="" class="img_poster">
                        </a>
                        <div class="title_info">
                    ...
                    <div class="movie_info">
                        <a href="">
                            <img src="IMAGE//moviestand/GoddamnedAsura_180x270_Poster.jpg" alt="" class="img_poster">
                        </a>
                        <div class="title_info">
                    ...
                    <div class="movie_info">
                        <a href="">
                            <img src="IMAGE/moviestand/5JoLmuOv0wzXt2DbER0f-1080x1538.jpg" alt="" class="img_poster">
                        </a>
                        <div class="title_info">
                            <h5 class="title_name">月球隕落</h5>
                            <img src="IMAGE/icons/mrs_15.png" alt="" class="level">
                        </div>
                    ...
                    <div class="movie_info">
                        <a href="">
                            <img src="IMAGE/moviestand/Blacklight_180x270_Poster.jpg" alt="" class="img_poster">
                        </a>
                        <div class="title_info">
                            <h5 class="title_name">黑光行動</h5>
                            <img src="IMAGE/icons/mrs_18.png" alt="" class="level">
                        </div>
    ...
    <!-- JS檔連結記得修改 -->
    <script src="<%=request.getContextPath()%>/view/movie/js/movie_overview.js"></script>
