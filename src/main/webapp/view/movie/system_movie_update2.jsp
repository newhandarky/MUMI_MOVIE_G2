...
<%-- 										<c:forEach var="movie_typeVO" items="${list}"> --%>
											<div class="form-check form-check-inline" id="type_num">
												<input class="form-check-input" type="checkbox"
													...
													name="movie_type_id"
													${(Movie_typeVO.movie_type_id==movie_typeVO.movie_type_id)?'checked':'' }>
...
<!-- 											<input class="form-check-input" type="checkbox" -->
<%-- 												value="${Movie_typeVO.movie_type_id}" id="flexCheckDefault" --%>
<%-- 												name="movie_type_id"> ${Movie_typeVO.movie_type_id} --%>
<!-- 										</div> -->
...
<!-- 								</div> -->
							...
							<br> <input type="hidden" name="action" value="type_update">
