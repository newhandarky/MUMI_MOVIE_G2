...
List<Movie_ratingVO> list = movie_ratingSvc.getAll();
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/view/movie_rating/css/system_movie_rating_listAll.css">
				...
				<div class="container">
					<div col="12">
						<div class="col-6">
							...
							<a class="btn btn-secondary" href='system_movie_rating_add.jsp'>新增電影標籤</a>
							<br> <br>
