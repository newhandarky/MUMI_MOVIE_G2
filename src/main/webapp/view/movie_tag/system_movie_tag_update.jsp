...
<%
Movie_tagVO movie_tagVO = (Movie_tagVO) request.getAttribute("movie_tagVO"); //Movie_tagServlet.java (Concroller) 存入req的movie_tagVO物件 (包括幫忙取出的movie_tagVO, 也包括輸入資料錯誤時的movie_tagVO物件)
%>
<html>
<head>
<meta charset="UTF-8">
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/view/movie_tag/css/system_movie_tag_update.css">
			...
			<div class="card">
				<div class="container">
					<div class="row g-3" col="12">
						<div class="col-md-6">
							<a class="btn btn-secondary" href="system_movie_tag_add.jsp">回新增頁面</a>
						</div>
						<div class="col-md-6">
							<a class="btn btn-secondary" href='system_movie_tag_listAll.jsp'>所有電影標籤</a>
							<jsp:useBean id="movie_tagSvc" scope="page"
						...
						<form method="post"
							...
							name="form1">
							<div class="mb-3 row">
								<label class="col-sm-2 col-form-label">標籤編號：</label>
								<div class="col-sm-3">
...
<!-- 							</div> -->
							...
							<input type="hidden" name="movie_tag_id"
								value="<%=movie_tagVO.getMovie_tag_id()%>"> <input
	...
	<script
		src="<%=request.getContextPath()%>/view/movie_tag/js/system_movie_tag_update.js"></script>
