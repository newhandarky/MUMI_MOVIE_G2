				...
				<div class="container">
					<div col="12">
						...
						<table class="table table-striped table-bordered table-sm">
							...
							<c:forEach var="releasingVO" items="${list}"
								...
								<tr>
									...
									<td>
										<FORM METHOD="post"
											...
											<input type="submit" value="修改" class="btn btn-success"> <input type="hidden"
												name="movie_state_id" value="${releasingVO.movie_state_id}">
