...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/view/ticket_orders/css/choose_seat.css">
</head>
...
<!-- JS檔連結記得修改 -->
<script
	src="${pageContext.request.contextPath}/view/ticket_orders/js/choose_seat.js"></script>
<script>
	$("input#movie_time_id").val(ticket_ordersVO.getMovie_time_id());
</script>
<script>
	$("input#seat_select_state").val(ticket_ordersVO.getSeat_select_state());
</script>
