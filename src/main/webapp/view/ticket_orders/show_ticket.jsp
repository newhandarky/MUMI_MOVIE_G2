...
<!-- css檔連結記得修改 -->
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/view/ticket_orders/css/show_ticket.css">
<link
							...
							<table class="table table-success table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<th class="tableval" id="movie_time" scope="col" colspan="3"
											value="${ticket_ordersVO.showing}"></th>
									</tr>
									<tr>
										<th scope="row">票券張數</th>
										<th class="tableval" scope="col" colspan="3">全票
											${ticket_ordersVO.ticket_number} 張</th>
									</tr>
									<tr>
...
<!-- JS檔連結記得修改 -->
<script
	src="<%=request.getContextPath()%>/view/ticket_orders/js/show_ticket.js"></script>
</body>
